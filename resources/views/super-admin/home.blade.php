                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body px-0">
                                                ...
                                                <div class="d-flex">
                                                    ...
                                                    <div class="ms-3">
                                                        ...
                                                        <span class="font-w400 d-block">Lorem ipsum dolor sit
                                                            amet, consectetur adipiscing elit, sed do<br> eiusmod
                                            ...
                                            <div class="d-flex justify-content-between recent-emails">
                                                <div class="d-flex">
                                                    <div class="profile-k">
                                                        <img src="./assets/images/profile/small/pic6.jpg"
                                                            alt="">
                                                    </div>
                                                    <div class="ms-3">
                                            ...
                                            <div class="d-flex justify-content-between recent-emails">
                                                <div class="d-flex">
                                                    <div class="profile-k">
                                                        <img src="./assets/images/profile/small/pic8.jpg"
                                                            alt="">
                                                    </div>
                                                    <div class="ms-3">
                                                        <h4 class="fs-18 font-w500">How to improve project
                                                ...
                                                <div class="card-body pb-0">
                                                    <div class="project-details">
                                                        <div class="d-flex align-items-center justify-content-between">
                                                            <div class="d-flex align-items-center">
                                                                <span class="big-wind">
                                                                    <img src="./assets/images/big-wind.png"
                                                                        alt="">
                                                                </span>
                                                                <div class="ms-3">
                                                                    <h4>Big Wind</h4>
                                                        ...
                                                        <h4 class="fs-16 font-w600 mt-4">Optimization Dashboard
                                                            Page for indexing in Google</h4>
                                                        <div class="projects">
                                                            <span
                                                    ...
                                                    <div class="project-details">
                                                        <div class="d-flex align-items-center justify-content-between">
                                                            <div class="d-flex align-items-center">
                                                                <span class="big-wind">
                                                                    <img src="./assets/images/circle-hunt.png"
                                                                        alt="">
                                                                </span>
                                                                <div class="ms-3">
                                                                    <h4>Circle Hunt</h4>
                                ...
                                <div class="col-xl-12 col-lg-12">
                                    <div class="card">
                                        <div class="card-header border-0">
                                            ...
                                            <div>
                                                <a href="javascript:void(0);" class="btn btn-primary btn-rounded">+New
                                                    Messages</a>
                                            </div>
                                        </div>
                                        <div class="card-body px-0">
                                            ...
                                            <div class="msg-bx d-flex justify-content-between align-items-center">
                                                <div class="msg d-flex align-items-center w-100">
                                                    <div class="image-box">
                                                        <img src="./assets/images/profile/small/pic7.jpg"
                                                            alt="">
                                                    </div>
                                                    <div class="ms-3 w-100">
                                            ...
                                            <div class="msg-bx d-flex justify-content-between align-items-center">
                                                <div class="msg d-flex align-items-center w-100">
                                                    <div class="image-box active">
                                                        <img src="./assets/images/profile/small/pic4.jpg"
                                                            alt="">
                                                    </div>
                                                    <div class="ms-3 w-100">
                                            ...
                                            <div class="msg-bx d-flex justify-content-between align-items-center">
                                                <div class="msg d-flex align-items-center w-100">
                                                    <div class="image-box active">
                                                        <img src="./assets/images/profile/small/pic3.jpg"
                                                            alt="">
                                                    </div>
                                                    <div class="ms-3 w-100">
                                            ...
                                            <div class="msg-bx d-flex justify-content-between align-items-center">
                                                <div class="msg d-flex align-items-center w-100">
                                                    <div class="image-box active">
                                                        <img src="./assets/images/profile/small/pic5.jpg"
                                                            alt="">
                                                    </div>
                                                    <div class="ms-3 w-100">
