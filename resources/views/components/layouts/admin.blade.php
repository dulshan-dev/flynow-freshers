...
<head>
    ...
    <meta name="keywords" content="flynow, air ticketing, ticketing, travel, booking, transportation" />
    <meta name="author" content="ishan" />
    <meta name="robots" content="index, follow" />
    <meta name="description" content="FlyNow.lk - The Fastest Way to Book Your Flights and Travel with Confidence" />
    <meta property="og:title" content="FlyNow.lk - The Fastest Way to Book Your Flights and Travel with Confidence" />
    <meta property="og:description" content="FlyNow.lk - The Fastest Way to Book Your Flights and Travel with Confidence" />
    ...
    ***********************************-->
    <div id="main-wrapper">
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown  header-profile">
                                <a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
                                    ...
                                    <img src="{{ asset('storage/' . Auth::user()->profile_photo_path) }}" width="56" alt="" />
                                    @else
        ...
        ***********************************-->
        <div class="dlabnav">
            <div class="dlabnav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/manage-admin">Manage Admins</a></li>
                            <li><a href="/manage-sub-agent">Manage Sub Agents</a></li>
                    ...
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                            ...
                            <span class="nav-text">Manage Agency</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="{{ route('manage.airline-commission') }}">Airline Commission</a></li>
                            <li><a href="{{ route('manage.airline-preference') }}">Airline Preference</a></li>
                            <li><a href="{{ route('manage.class-master') }}">Class Master</a></li>
                            <li><a href="{{ route('manage.custom-rule-check') }}">Custom Rule Check</a></li>
                            <li><a href="{{ route('manage.deal-code-master') }}">Deal Code Master</a></li>
                            <li><a href="{{ route('manage.discount-details') }}">Discount Details</a></li>
                            <li><a href="{{ route('manage.good-service-tax') }}">Good Service Tax</a></li>
                            <li><a href="">Mark Up Fee</a></li>
                            <li><a href="{{ route('manage.offline-payment') }}">Offline Payment</a></li>
                            <li><a href="{{ route('manage.private-fare-account-code') }}">Private Fare Account Code</a></li>
                            <li><a href="{{ route('manage.service-tax') }}">Service Tax</a></li>
                            <li><a href="{{ route('manage.tds-master') }}">TDS Master</a></li>
                            <li><a href="{{ route('manage.transaction-fee') }}">Transaction Fee</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a href="{{ route('manage.modify-pnr') }}" aria-expanded="false">
                            ...
                            <span class="nav-text">Modify PNR</span>
                        </a>
                    </li>
                    ...
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                            ...
                            <span class="nav-text">Series Fare</span>
                        </a>
                    </li>
                ...
                <!-- <div class="copyright">
                    <p><strong>Flynow Admin</strong> © 2021 All Rights Reserved</p>
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright © Designed &amp; Developed by <a href="https://www.thetravelport.lk/" target="_blank">Travel Port IT Department</a> 2023</p>
            </div>
        </div>
        <!--**********************************
            Footer end
