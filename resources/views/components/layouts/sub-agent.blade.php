                    ...
                    <div class="collapse navbar-collapse justify-content-between">
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown  header-profile">
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    <a href="{{ route('sub-agent.profile') }}" class="dropdown-item ai-icon">
        ...
        <div class="dlabnav">
            <div class="dlabnav-scroll">
                <ul class="metismenu" id="menu">
                    <li><a href="{{route('sub-agent.home')}}" aria-expanded="false">
                            <i class="bi bi-house-door"></i>
                            <span class="nav-text">Dashboard</span>
                        </a>
                    </li>

                    <li><a href="{{ route('sub-agent.quoteList') }}" aria-expanded="false">
                            <i class="bi bi-cash-stack"></i>
                            <span class="nav-text">Quote List</span>
                        </a>
                    </li>

                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                            <i class="bi bi-card-text"></i>
                            <span class="nav-text">Flight Ticket</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="">Issue Flight Ticket</a></li>
                            <li><a href="">Flight Ticket List</a></li>
                            <li><a href="">Ticket Documents</a></li>
                    ...
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                            ...
                            <span class="nav-text">Flight Booking</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="{{ route('sub-agent.flightSearch') }}">Flight Search</a></li>
                            <li><a href="">Advanced Flight Search</a></li>
                            <li><a href="">Flight Booking List</a></li>
                        </ul>
                    </li>

                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                            <i class="bi bi-shield-check"></i>
                            <span class="nav-text">Travel Insurance</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="{{ route('sub-agent.getQuoteOrInsurance') }}">Get Quote/Insurance</a></li>
                            <li><a href="{{ route('sub-agent.insuranceList') }}">Insurance List</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{ route('sub-agent.transactions') }}">Transactions</a></li>
                            <li><a href="{{ route('sub-agent.statements') }}">Statements</a></li>
                            <li><a href="{{ route('sub-agent.transactionOverview') }}">Transaction Overview</a></li>
                        </ul>
                    </li>

                    <li><a href="{{ route('sub-agent.topupRequests') }}" aria-expanded="false">
                   ...
                   <li> <a href="{{ route('sub-agent.a-d-m') }}" aria-expanded="false">
                    ...
                    <li><a href="javascript:void()" aria-expanded="false">
                            ...
                            <span class="nav-text">Card Payment</span>
                        </a>
                    </li>
